...
from esphome.const import CONF_DC_PIN, CONF_ID, CONF_LAMBDA, CONF_MODEL, CONF_RESET_PIN, CONF_PAGES, CONF_CS_PIN, CONF_SPI_ID
...
MODELS = {
    ...
    'INITR_144GREENTAB': ST7735Model.ST7735_INITR_144GREENTAB,
